...
void ConfigureOscillator(void) {
    PLLFBD = 38; // M=PLLFBD+2 -> M = 40
    CLKDIVbits.PLLPOST = 0; // N1=CLKDIVbits.PLLPOST+2 -> N1 = 2
    CLKDIVbits.PLLPRE = 0; //N2=CLKDIVbits.PLLPRE+2 -> N2 = 2
    OSCTUN = 0;
    RCONbits.SWDTEN = 0;

    ACLKCONbits.FRCSEL = 1; /* FRC provides input for Auxiliary PLL (x16) */
    ACLKCONbits.SELACLK = 1; /* Auxiliary Oscillator provides clock source for PWM & ADC */
    ACLKCONbits.APSTSCLR = 7; /* Divide Auxiliary clock by 256 */
